...
export class BootScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    this.load.audio('sfx:melee-light', 'assets/audio/sfx/hit.ogg')
    this.load.audio('sfx:melee-heavy', 'assets/audio/sfx/hit.ogg')
    this.load.audio('sfx:ranged-shot', 'assets/audio/sfx/hit.ogg')
    this.load.audio('sfx:magic-cast', 'assets/audio/sfx/skill.ogg')
    this.load.audio('sfx:heal', 'assets/audio/sfx/skill.ogg')
    this.load.audio('sfx:counter', 'assets/audio/sfx/hit.ogg')
    this.load.audio('sfx:phase-shift', 'assets/audio/sfx/victory.ogg')
    this.load.audio('sfx:kill-confirm', 'assets/audio/sfx/defeat.ogg')
